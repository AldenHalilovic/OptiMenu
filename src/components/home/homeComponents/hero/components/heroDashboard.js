  ...
  return (
    <Container maxWidth="lg">
      ...
      <Typography
        variant="subtitle1"
        className="text"
        sx={{ mb: 2.5, letterSpacing: 1, width: "70%", textAlign: "center", mx: "auto" }}
      >
        ...
        <Grid item xs={12} sm={5.5}>
          <Card>
            <CardContent sx={{ background: "#ed6c02", color: "#fff" }}>
              <Typography variant="h6" color="white" sx={{ borderBottom: "1px solid #fff", mb: 2 }}>
                Paperless System
              </Typography>
              <Typography variant="body2" color="#fff" className="text" letterSpacing={0.8}>
